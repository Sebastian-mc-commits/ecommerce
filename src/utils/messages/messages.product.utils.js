...
const productMessages = {
    DELETED_PRODUCT: (title) => `${title} Has been deleted. If you want to restore the product go to your account and deleted products`,
    UPDATED_PRODUCT: (title) => `Product ${title} update successful! Enjoy the new features and enhancements.`,
    ...
    PRODUCT_PERMANENTLY_DELETED: title => `We wanted to inform you that the product you requested to be deleted, 
    ...
    PRODUCT_RESTORED: title => `We're writing to let you know that the product, ${title}, has been restored to our 
