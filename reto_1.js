class ProductManager {
  ...
  getProductById = (id) =>
    this.#products.find((p) => p.id === id) || "Not found";
}
const netboock = {
  title: "Portatil",
  description: "8gb ram, icore-5",
  price: 2000000,
  thumbnail: "./",
  code: "1200s",
  stock: 6
...
const removeConsecutiveRepeatedWords = (word) => {
  let newWord = "";
  for (let i = 0; i < word.length; i++) {
    if (newWord && newWord[newWord.length - 1] === word[i]) continue;
    newWord += word[i];
  }
